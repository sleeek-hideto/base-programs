...
*	@param[in] in2 ベクトル２
*/
CVector3H* CVector3H::Add( CVector3H *in1, CVector3H *in2 )
{
...
*/
CVector3H* CVector3H::Sub( CVector3H *inLeft, CVector3H *inRight )
{
...
*/
CVector3H* CVector3H::Mul( CMatrix *inLeft, CMatrix *inRight )
{
...
*/
CVector3H* CVector3H::CrossProduct( CVector3H *inLeft, CVector3H *inRight )
{
...
*	@param[in] in1 ベクトル
*/
CVector3H* CVector3H::Transpose( CMatrix *in )
{
...
*	@param[in] in ベクトル
*/
CVector3H* CVector3H::MulConst( double c, CVector3H *in )
{
...
/*!
	@brief Dir(0,1,0)が、vDirの値を取るための回転角を求める
	@param[in] vDir 斉次行列
*/
void CVector3H::CalcAngleFromDir_YXZ( CVector3H* vDir )
{
	double radianTo360 = 180.0 / 3.14159265;
	double angleX, angleY;
	double *dir = vDir->GetData();
	if( dir[2]==0.0 ){
		if(dir[1]>0.0){ angleX = 0.0; }else{ angleX = -180.0; }
		angleY = 0.0;
	}else{
		angleX = radianTo360 * acos( dir[1] );
		angleY = radianTo360 * atan2( dir[0], dir[2] );
	}
}
